...
<body>
    <div class="container">
        <div class="breadcrumb">
            ...
            <a href="/public/group-admin/lottery.php">Lottery Events</a> /
            <a href="/public/group-admin/lottery-reports.php?id=<?php echo $eventId; ?>">Reports</a> /
            Reset Commission
        </div>
            ...
            <div class="card">
                ...
                <form method="POST" onsubmit="return confirm('Are you absolutely sure you want to DELETE ALL commission records? This CANNOT be undone!');">
                    ...
                    <div class="button-group">
                        ...
                        <a href="/public/group-admin/lottery-reports.php?id=<?php echo $eventId; ?>" class="btn btn-secondary">
                            Cancel
                        </a>
                    </div>
                </form>
