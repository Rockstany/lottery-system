    ...
    <div class="container" style="max-width: 1200px; margin: 40px auto; padding: 0 20px;">
        ...
        <div class="action-grid">
            <div class="action-card">
                ...
                <a href="/public/group-admin/csf-record-payment.php" class="action-btn">Record Payment</a>
            </div>
            ...
            <div class="action-card">
                ...
                <a href="/public/group-admin/csf-reports.php" class="action-btn">View Reports</a>
            </div>
            ...
            <div class="action-card">
                ...
                <a href="/public/group-admin/csf-send-reminders.php" class="action-btn">Send Reminders</a>
            </div>
