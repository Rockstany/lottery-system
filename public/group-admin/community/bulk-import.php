...
if ($step === 'confirm' && isset($_SESSION['bulk_import_data'])) {
    ...
    try {
        ...
        $redirectUrl = $type === 'sub_communities' ? '/public/group-admin/sub-communities.php' : '/public/group-admin/community/community-members.php';
...
$breadcrumbs = [
    ...
    ['label' => 'Bulk Operations', 'url' => '/public/group-admin/community/bulk-operations.php'],
            ...
            <div class="upload-area">
                ...
                <form method="POST" enctype="multipart/form-data" action="">
                    ...
                    <div class="action-buttons">
                        ...
                        <a href="/public/group-admin/community/bulk-operations.php" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
