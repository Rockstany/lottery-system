...
if (isset($_POST['bulk_action']) && $_POST['bulk_action'] === 'delete' && isset($_POST['selected_items'])) {
    ...
    if (count($selectedIds) > 0) {
        ...
        header('Location: /public/group-admin/community/bulk-delete-confirm.php');
        exit();
    }
}
    ...
    <div class="container" style="max-width: 1400px; margin: 0 auto; padding: 20px;">
        ...
        <div class="header-actions">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="/public/group-admin/community/bulk-operations.php" class="btn-primary" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                    📊 Bulk Operations
                </a>
                <a href="/public/group-admin/community/sub-community-create.php" class="btn-primary">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="card-actions">
                                <a href="/public/group-admin/community/sub-community-view.php?id=<?php echo $subComm['sub_community_id']; ?>"
                                   class="btn-sm btn-view">View</a>
                                <a href="/public/group-admin/community/sub-community-edit.php?id=<?php echo $subComm['sub_community_id']; ?>"
