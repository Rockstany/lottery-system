...
if (!isset($_SESSION['pending_delete_ids']) || !isset($_SESSION['delete_type'])) {
    header('Location: /public/group-admin/community/community-building.php');
    exit();
}
...
if (isset($_POST['cancel_delete'])) {
    ...
    $redirectUrl = $deleteType === 'sub_communities' ? '/public/group-admin/sub-communities.php' : '/public/group-admin/community/community-members.php';
