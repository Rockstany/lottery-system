...
<body>
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 20px;">
        ...
        <div class="action-grid">
            ...
            <a href="/public/group-admin/community/custom-fields.php" style="text-decoration: none;">
                <div class="action-card">
                    <div class="icon">📝</div>
                    <h3>Custom Fields</h3>
            ...
            <a href="/public/group-admin/community/community-members.php" style="text-decoration: none;">
                <div class="action-card">
                    <div class="icon">👤</div>
                    <h3>Members</h3>
            ...
            <a href="/public/group-admin/community/bulk-operations.php" style="text-decoration: none;">
