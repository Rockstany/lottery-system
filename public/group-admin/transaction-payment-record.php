                        ...
                        <form method="POST">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    step="0.01"
                                    min="0.01"
                                    max="<?php echo $member['outstanding_amount']; ?>"
                                    placeholder="Enter amount"
                                    value="<?php echo $member['outstanding_amount']; ?>"
                                    required
                                    autofocus
                                >
                                <span class="form-help">Outstanding: ₹<?php echo number_format($member['outstanding_amount'], 2); ?></span>
                            </div>
