    ...
    <script>
        ...
        memberSearchInput.addEventListener('input', function() {
            ...
            searchTimeout = setTimeout(() => {
                fetch(`/public/group-admin/csf/csf-api-search-member.php?q=${encodeURIComponent(query)}`)
        ...
        async function checkDuplicatePayment() {
            ...
            try {
                ...
                const response = await fetch('/public/group-admin/csf/csf-api-check-duplicate.php', {
                    method: 'POST',
                    body: formData
                });
