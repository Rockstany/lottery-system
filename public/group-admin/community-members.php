    ...
    <div class="container" style="max-width: 1400px; margin: 0 auto; padding: 20px;">
        ...
        <div class="header-actions">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="/public/group-admin/member-register.php" class="btn-primary">
                    + Register New Member
                </a>
    ...
    <script>
        ...
        function confirmRemove(userId) {
            if (confirm('Are you sure you want to remove this member from their sub-community?')) {
                window.location.href = '/public/group-admin/community-members.php?action=remove&user_id=' + userId;
            }
        }
    </script>
