...
if (!$payment['is_editable']) {
    header("Location: /public/group-admin/lottery-payment-transactions.php?dist_id=$distId&error=not_editable");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($newAmount <= 0) {
        ...
        try {
            ...
            header("Location: /public/group-admin/lottery-payment-transactions.php?dist_id=$distId&success=payment_edited");
            exit;
...
<body>
    ...
    <div class="container main-content">
        ...
        <div style="margin-bottom: var(--spacing-lg);">
            <a href="/public/group-admin/lottery-payment-transactions.php?dist_id=<?php echo $distId; ?>" class="btn btn-secondary">← Back to Transactions</a>
        </div>
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div style="display: flex; gap: var(--spacing-md); margin-top: var(--spacing-lg);">
                        ...
                        <a href="/public/group-admin/lottery-payment-transactions.php?dist_id=<?php echo $distId; ?>" class="btn btn-secondary" style="flex: 1;">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
