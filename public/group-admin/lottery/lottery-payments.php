...
<body>
    ...
    <div class="container main-content">
        ...
        <div style="margin-bottom: var(--spacing-lg); display: flex; gap: var(--spacing-md); flex-wrap: wrap;">
            ...
            <a href="/public/group-admin/lottery/lottery-books.php?id=<?php echo $eventId; ?>" class="btn btn-primary">View Books</a>
            <a href="/public/group-admin/lottery/lottery-payment-bulk.php?id=<?php echo $eventId; ?>" class="btn btn-success">💰 Bulk Payment Collection</a>
        </div>
            ...
            <div class="card-body" style="padding: 0;">
                <?php if (count($distributions) === 0): ?>
                    <div style="text-align: center; padding: var(--spacing-2xl); color: var(--gray-500);">
                        ...
                        <a href="/public/group-admin/lottery/lottery-books.php?id=<?php echo $eventId; ?>" class="btn btn-primary">
                                        ...
                                        <td>
                                            <div style="display: flex; flex-direction: column; gap: var(--spacing-xs);">
                                                ...
                                                <div style="display: flex; gap: var(--spacing-xs); flex-wrap: wrap;">
                                                    <?php if ($status !== 'paid'): ?>
                                                        <a href="/public/group-admin/lottery/lottery-payment-collect.php?book_id=<?php echo $dist['book_id']; ?>" class="btn btn-sm btn-success">
                                                            💰 Collect
                                                        </a>
                                                    <?php endif; ?>
                                                    <?php if ($dist['total_paid'] > 0): ?>
                                                        <a href="/public/group-admin/lottery/lottery-payment-transactions.php?dist_id=<?php echo $dist['distribution_id']; ?>" class="btn btn-sm btn-info">
                                                            📋 Transactions
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
