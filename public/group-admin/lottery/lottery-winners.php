...
<body>
    ...
    <div class="container main-content">
        ...
        <div style="margin-bottom: var(--spacing-lg);">
            ...
            <a href="/public/group-admin/lottery/lottery-reports.php?id=<?php echo $eventId; ?>" class="btn btn-primary">View Reports</a>
        </div>
        ...
        <div class="card">
            <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <?php if (count($winners) > 0): ?>
                    <a href="/public/group-admin/lottery/lottery-winners-export.php?id=<?php echo $eventId; ?>" class="btn btn-primary btn-sm">
                        📥 Export to CSV
                    </a>
                <?php endif; ?>
            </div>
