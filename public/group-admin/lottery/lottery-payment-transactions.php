...
<body>
    ...
    <div class="container main-content">
        ...
        <div style="margin-bottom: var(--spacing-lg);">
            <a href="/public/group-admin/lottery/lottery-payments.php?id=<?php echo $distribution['event_id']; ?>" class="btn btn-secondary">← Back to Payments</a>
        </div>
            ...
            <div class="card-body" style="padding: 0;">
                <?php if (count($transactions) === 0): ?>
                    <div style="text-align: center; padding: var(--spacing-2xl); color: var(--gray-500);">
                        ...
                        <a href="/public/group-admin/lottery/lottery-payment-collect.php?book_id=<?php echo $distribution['book_id']; ?>" class="btn btn-success">
                            Collect Payment
                        </a>
                    </div>
                <?php else: ?>
                                        ...
                                        <td>
                                            <div style="display: flex; gap: var(--spacing-xs); flex-wrap: wrap;">
                                                <?php if ($trans['is_editable']): ?>
                                                    <a href="/public/group-admin/lottery/lottery-payment-edit.php?payment_id=<?php echo $trans['payment_id']; ?>&dist_id=<?php echo $distributionId; ?>"
