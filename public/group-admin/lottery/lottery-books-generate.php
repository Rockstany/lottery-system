...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm'])) {
    ...
    header("Location: /public/group-admin/lottery/lottery-distribution-setup.php?id={$eventId}");
    exit;
}
?>
<!DOCTYPE html>
        ...
        <?php else: ?>
            ...
            <form method="POST">
                ...
                <div style="display: flex; gap: var(--spacing-md);">
                    ...
                    <a href="/public/group-admin/lottery/lottery-books-generate.php?id=<?php echo $eventId; ?>" class="btn btn-secondary">
                        ← Change Settings
                    </a>
                </div>
            </form>
