...
<body>
    ...
    <div class="container main-content">
        ...
        <div class="card">
            <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="/public/group-admin/lottery/lottery-create.php" class="btn btn-primary">
                    + Create New Event
                </a>
            </div>
        </div>
        ...
        <?php if (count($events) === 0): ?>
            <div class="empty-state">
                ...
                <a href="/public/group-admin/lottery/lottery-create.php" class="btn btn-primary btn-lg" style="margin-top: var(--spacing-lg);">
            ...
            <?php foreach ($events as $event): ?>
                ...
                <div class="event-card">
                    ...
                    <div class="action-buttons-wrap">
                        <a href="/public/group-admin/lottery/lottery-edit.php?id=<?php echo $event['event_id']; ?>" class="btn btn-warning btn-sm">
                            <span>✏️</span> <span>Edit</span>
                        </a>
                        <a href="/public/group-admin/lottery/lottery-books.php?id=<?php echo $event['event_id']; ?>" class="btn btn-primary btn-sm">
                            <span>📚</span> <span>Books</span>
                        </a>
                        <a href="/public/group-admin/lottery/lottery-payments.php?id=<?php echo $event['event_id']; ?>" class="btn btn-success btn-sm">
                            <span>💰</span> <span>Payments</span>
                        </a>
                        <a href="/public/group-admin/lottery/lottery-winners.php?id=<?php echo $event['event_id']; ?>" class="btn btn-sm" style="background: #f59e0b; color: white;">
                            <span>🏆</span> <span>Winners</span>
                        </a>
                        <a href="/public/group-admin/lottery/lottery-commission-setup.php?id=<?php echo $event['event_id']; ?>" class="btn btn-sm" style="background: <?php echo $event['commission_enabled'] ? '#10b981' : '#6b7280'; ?>; color: white;" title="<?php echo $event['commission_enabled'] ? 'Commission is enabled' : 'Commission is disabled'; ?>">
                            <span>💰</span> <span>Commission <?php echo $event['commission_enabled'] ? '✓' : ''; ?></span>
                        </a>
                        <a href="/public/group-admin/lottery/lottery-reports.php?id=<?php echo $event['event_id']; ?>" class="btn btn-secondary btn-sm">
    ...
    <script>
        ...
        function deleteEvent() {
            ...
            window.location.href = '/public/group-admin/lottery/lottery-delete.php?id=' + deleteEventId;
        }
        ...
        document.getElementById('deleteRequestForm').addEventListener('submit', function(e) {
            ...
            form.method = 'POST';
            form.action = '/public/group-admin/lottery/lottery-delete-request.php';
