...
<body>
    ...
    <div class="container main-content">
        ...
        <div style="margin-bottom: var(--spacing-lg); display: flex; gap: var(--spacing-sm); flex-wrap: wrap;">
            ...
            <a href="/public/group-admin/lottery/lottery-book-bulk-assign.php?id=<?php echo $eventId; ?>" class="btn btn-primary">📚 Bulk Assign Books</a>
            <a href="/public/group-admin/lottery/lottery-payments.php?id=<?php echo $eventId; ?>" class="btn btn-success">View Payments</a>
        </div>
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                    <tr class="<?php echo $book['book_status'] !== 'available' ? 'assigned-row' : ''; ?>">
                                        ...
                                        <td>
                                            <?php if ($book['book_status'] === 'available'): ?>
                                                <a href="/public/group-admin/lottery/lottery-book-assign.php?book_id=<?php echo $book['book_id']; ?>&event_id=<?php echo $eventId; ?>"
                                                   class="btn btn-sm btn-primary">Assign</a>
                                            <?php else: ?>
                                                <div style="display: flex; gap: var(--spacing-xs); flex-wrap: wrap;">
                                                    <a href="/public/group-admin/lottery/lottery-payments.php?id=<?php echo $eventId; ?>"
                                                       class="btn btn-sm btn-success">View Payments</a>
                                                    <a href="/public/group-admin/lottery/lottery-book-reassign.php?dist_id=<?php echo $book['distribution_id']; ?>"
