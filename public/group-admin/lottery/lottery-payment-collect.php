    ...
    if ($paymentType === 'no_payment') {
        if (empty($returnReason)) {
            ...
            try {
                ...
                $db->commit();
                header("Location: /public/group-admin/lottery/lottery-books.php?id={$book['event_id']}&success=book_returned");
                exit;
            } catch (Exception $e) {
                $db->rollBack();
    ...
    <div class="container main-content">
        <?php if ($success): ?>
            <div class="alert alert-success">
                <?php echo $success; ?>
                <a href="/public/group-admin/lottery/lottery-payments.php?id=<?php echo $book['event_id']; ?>" style="margin-left: var(--spacing-md);">
                    Back to Payments →
                </a>
            </div>
        <?php endif; ?>
                    ...
                    <div class="card-body">
                        <form method="POST" id="paymentForm">
                            ...
                            <div class="button-group-mobile">
                                ...
                                <a href="/public/group-admin/lottery/lottery-payments.php?id=<?php echo $book['event_id']; ?>" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
