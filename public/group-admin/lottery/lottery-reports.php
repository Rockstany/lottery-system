...
<body>
    ...
    <div class="container main-content">
        ...
        <div style="margin-bottom: var(--spacing-lg);">
            ...
            <a href="/public/group-admin/lottery/lottery-books.php?id=<?php echo $eventId; ?>" class="btn btn-primary">Manage Books</a>
            <a href="/public/group-admin/lottery/lottery-payments.php?id=<?php echo $eventId; ?>" class="btn btn-success">Track Payments</a>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div style="display: flex; flex-direction: column; gap: var(--spacing-sm);">
                            <a href="/public/group-admin/lottery/lottery-reports-excel-template.php?id=<?php echo $eventId; ?>&type=with_data" class="btn btn-primary" style="width: 100%;">
                                📥 Download with Current Data
                            </a>
                            <a href="/public/group-admin/lottery/lottery-reports-excel-template.php?id=<?php echo $eventId; ?>&type=blank" class="btn btn-secondary" style="width: 100%;">
                                📄 Download Blank Template
                            </a>
                            <a href="/public/group-admin/lottery/lottery-reports-excel-export.php?id=<?php echo $eventId; ?>" class="btn btn-success" style="width: 100%;">
                                📊 Download Full Report (Read-Only)
                            </a>
                            <a href="/public/group-admin/lottery/lottery-final-report-excel.php?id=<?php echo $eventId; ?>" class="btn" style="width: 100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; font-weight: bold; margin-top: var(--spacing-sm);">
                            ...
                            <a href="/public/group-admin/lottery/lottery-commission-reset.php?id=<?php echo $eventId; ?>" class="btn btn-danger" style="width: 100%; margin-top: var(--spacing-md);">
                    ...
                    <div class="col-6">
                        ...
                        <form action="/public/group-admin/lottery/lottery-reports-excel-upload.php" method="POST" enctype="multipart/form-data" id="uploadForm" style="background: white; padding: var(--spacing-lg); border-radius: var(--radius-md); box-shadow: var(--shadow-sm);">
