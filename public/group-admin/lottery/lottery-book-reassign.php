    ...
    if ($paymentInfo['payment_count'] > 0) {
        ...
        if (count($levels) > 0 && count($missingLevels) > 0) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: /public/group-admin/lottery/lottery-books.php?id={$eventId}&success=reassigned");
                exit;
            } else {
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div style="margin-top: var(--spacing-lg); display: flex; gap: var(--spacing-md);">
                        ...
                        <a href="/public/group-admin/lottery/lottery-books.php?id=<?php echo $eventId; ?>" class="btn btn-secondary btn-lg">
                            Cancel
                        </a>
                    </div>
                </form>
