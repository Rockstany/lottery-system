    ...
    if (empty($currentPassword) || empty($newPassword) || empty($confirmPassword)) {
        ...
        if (!$user || !password_verify($currentPassword, $user['password_hash'])) {
            ...
            if ($stmt->execute()) {
                ...
                // Log the activity
                $activityQuery = "INSERT INTO activity_log (user_id, action, details) VALUES (:user_id, 'password_change', 'Admin changed their password')";
        ...
        <div class="password-container">
            <?php if ($success): ?>
                <div class="alert alert-success">
                    <?php echo $success; ?>
                    <a href="/public/admin/dashboard.php" style="margin-left: var(--spacing-md);">
                        Back to Dashboard →
                    </a>
                </div>
            <?php endif; ?>
                ...
                <div class="card-body">
                    <form method="POST" id="passwordForm">
                        ...
                        <div style="display: flex; gap: var(--spacing-md); margin-top: var(--spacing-xl);">
                            ...
                            <a href="/public/admin/dashboard.php" class="btn btn-secondary">
                                Cancel
                            </a>
                        </div>
                    </form>
